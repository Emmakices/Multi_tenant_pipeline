...
def process_file():
    ...
    try:
        ...
        processed_data, bad_records = process_ecommerce_data(file_path, file_name, tenant_id, region)
...
def process_ecommerce_data(file_path: str, file_name: str, tenant_id: str, region: str) -> Tuple[pd.DataFrame, pd.DataFrame]:
    """
...
def create_ml_features(df: pd.DataFrame, tenant_id: str, file_name: str, region: str) -> pd.DataFrame:
