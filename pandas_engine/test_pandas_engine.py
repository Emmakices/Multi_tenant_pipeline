...
from main import (BASE_DATASET_ID, EXPECTED_COLUMNS, PROJECT_ID,
                  ...
                  create_ml_features, download_file_from_gcs,
                  extract_tenant_from_path, get_bigquery_location,
                  get_regional_dataset_id, move_file_to_bad_records,
                  perform_data_quality_checks, process_ecommerce_data,
                  save_bad_records, save_to_bigquery_historical,
                  validate_schema)
...
class TestDataProcessing:
    ...
    def test_create_ml_features_error_handling(self, sample_ecommerce_data):
        ...
        bad_data["event_time"] = (
            "invalid_time"  # This will cause issues in feature creation
        )

        with patch(
            "pandas.to_datetime", side_effect=Exception("Time conversion error")
        ):
...
class TestBigQueryOperations:
    ...
    def test_save_to_bigquery_historical_success(
        ...
        with patch(
            ...
            result = save_to_bigquery_historical(
    ...
    def test_save_to_bigquery_dataset_creation(
        self, mock_bq_client, sample_ecommerce_data
    ):
...
class TestFlaskEndpoints:
    ...
    def test_process_file_success(
        ...
        with patch("main.download_file_from_gcs") as mock_download, patch(
            ...
            "main.save_to_bigquery_historical"
        ) as mock_save_bq, patch(
            "main.save_bad_records"
    ...
    def test_process_file_with_bad_records(
...
class TestErrorHandling:
    ...
    def test_process_malformed_csv(self, client):
        ...
        ), patch("main.move_file_to_bad_records") as mock_move, patch("os.unlink"):
...
class TestSecurity:
    ...
    def test_sql_injection_protection_in_metadata(self, sample_ecommerce_data):
        ...
        assert (
            result["tenant_id"].iloc[0] == malicious_tenant
